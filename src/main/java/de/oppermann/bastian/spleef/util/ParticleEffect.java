...
import de.oppermann.bastian.spleef.util.ReflectionUtils.PackageType;
...
public enum ParticleEffect {
	...
	public boolean isSupported() {
		...
		return true; // ParticlePacket.getVersion() >= requiredVersion; // seems to be buggy with spigot
	}
